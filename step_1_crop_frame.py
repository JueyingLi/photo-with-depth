...
快速测试:
    python step_1_crop_frame.py                          # 用默认样例
    python step_1_crop_frame.py --input path/to/img.png  # 换图
    python step_1_crop_frame.py --input img.png --window 21 --pad 6 --save out.png
